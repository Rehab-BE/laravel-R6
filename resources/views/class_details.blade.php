        ...
        <div class="card bg-light border-0">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 col-10 position-relative overflow-hidden">
              <img src="{{asset('asset/images/classes/'. $class->image)}}" alt="{{ $class->class_name }}"
                class="card-img"
            ...
            <div class="col-lg-8 col-md-6 col-12 card-body">
              ...
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Price:</span><br>{{$class['price']}}
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Time:</span><br>{{$class['time_from']}}<br>{{$class['time_to']}}
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Is Fulled:</span> {{ $class->is_fulled ? 'Yes' : 'No' }}
                </p>
              </div>
